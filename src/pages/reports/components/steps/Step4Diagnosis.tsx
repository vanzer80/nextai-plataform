  ...
  return (
    <Card className="shadow-sm border-slate-200">
      ...
      <CardContent className="pt-5 space-y-5">
        ...
        <div className="space-y-2">
          <Label className="text-sm font-semibold text-slate-700">Diagnóstico preliminar</Label>
          <Textarea
        ...
        <div className="space-y-2">
          <Label className="text-sm font-semibold text-slate-700">Diagnóstico final</Label>
          <Textarea
