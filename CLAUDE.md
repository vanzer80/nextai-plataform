...
| **A11y — 10 violações Axe (app-wide, pré-existentes)** | Corrigido na Sessão 69: sweep de `aria-label` nos botões de ícone e SelectTriggers em 9 telas (17 nós) + label do formulário de reembolsos associado (2 nós). | ✅ Concluído na Sessão 69 |
